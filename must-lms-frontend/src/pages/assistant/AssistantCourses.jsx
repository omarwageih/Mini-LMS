...
const AssistantCourses = () => {
    ...
    return (
        <motion.div 
            initial={{ opacity: 0 }} 
            animate={{ opacity: 1 }} 
            className="min-h-screen pb-24 pt-4 px-4 sm:px-10"
        >
            <div className="max-w-7xl mx-auto space-y-16">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight uppercase italic">
                        Assigned <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Modules</span>
                    </h1>
                    <p className="text-slate-500 dark:text-slate-400 text-sm max-w-2xl mx-auto font-bold italic opacity-80 uppercase tracking-widest">
                        Terminal View • Courses Under Your Supervision
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {courses.length === 0 ? (
                        <div className="col-span-full py-20 text-center glass-card border-dashed">
                             <p className="text-slate-400 text-sm font-black uppercase tracking-[0.3em] opacity-40">Access Denied • No Courses Assigned</p>
                        </div>
                            ...
                            <Link to={`/assistant/submissions?courseId=${course.CourseID}`} key={course.CourseID} className="block group">
                                ...
                                >
                                    ...
                                    <div className="p-8 space-y-6">
                                        ...
                                        {/* Dynamic Stats Divider */}
                                        <div className="flex items-center gap-6 py-5 border-y border-slate-50 dark:border-white/5">
                                            <div className="flex flex-col gap-1">
                                                <span className="text-[9px] text-slate-400 font-black uppercase tracking-[0.2em]">Timeline</span>
                                            ...
                                            <div className="flex flex-col gap-1">
                                                <span className="text-[9px] text-slate-400 font-black uppercase tracking-[0.2em]">Assigned</span>
                                                <div className="flex items-center gap-1.5 text-slate-700 dark:text-slate-200 font-black text-xs">
